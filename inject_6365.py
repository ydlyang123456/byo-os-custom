#!/usr/bin/env python3
"""Inject Batch 63-65 into shell.c"""
import re
...
# Find last forward declaration
last_fwd_match = re.search(r'static void cmd_\w+\(int argc, char args\[\]\[CMD_MAX_LEN\]\);\n', shell)
# Use gretl59 as anchor
last_fwd = "static void cmd_gretl59(int argc, char args[][CMD_MAX_LEN]);"
# Find the last one (should be from batch 62)
...
# Inject function bodies before shell_run
