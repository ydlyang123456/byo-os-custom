...
SOURCES=""
for f in kernel/string.c kernel/font.c kernel/vga.c kernel/serial.c kernel/fs.c kernel/journal.c kernel/shell.c kernel/ata.c kernel/ahci.c kernel/rtc.c kernel/pci.c kernel/fat32.c kernel/ext2.c kernel/tcpip.c kernel/sound.c kernel/gfx_enhanced.c kernel/usb.c kernel/vbe.c; do
