...
static const cmd_entry commands[] = {
    ...
    {"cmd_df", cmd_df_v2},
    {"cmd_free", cmd_free_v2},
    {"cmd_ps", cmd_ps_v2},
    {"cmd_top", cmd_top_v2},
    {"cmd_uname", cmd_uname_v2},
    {"cmd_date", cmd_date_v2},
    {"cmd_uptime", cmd_uptime_v2},
    {"cmd_id", cmd_id_v2},
    {"cmd_dmesg", cmd_dmesg_v2},
    {"cmd_last", cmd_last_v2},
    {"cmd_w", cmd_w_v2},
    {"cmd_whoami", cmd_whoami_v2},
    {"cmd_logname", cmd_logname},
    {"cmd_groups", cmd_groups_v2},
    {"cmd_hostnamectl", cmd_hostnamectl_v2},
    {"cmd_timedatectl", cmd_timedatectl_v2},
    {"cmd_sysctl", cmd_sysctl_v2},
    {"cmd_fdisk", cmd_fdisk_v2},
    {"cmd_blkid", cmd_blkid_v2},
    {"cmd_lsblk", cmd_lsblk_v2},
    {"cmd_vmstat", cmd_vmstat_v2},
    {"cmd_iostat", cmd_iostat_v2},
    {"cmd_mpstat", cmd_mpstat_v2},
    {"cmd_sar", cmd_sar_v2},
    {"cmd_mkfs", cmd_mkfs_v2},
    {"cmd_sestatus", cmd_sestatus},
    {"cmd_mktemp", cmd_mktemp},
    {"cmd_mknod", cmd_mknod},
    {"cmd_fsck", cmd_fsck},
    {"cmd_smartctl", cmd_smartctl_v2},
    {"cmd_dmidecode", cmd_dmidecode_v2},
    {"cmd_cpuid", cmd_cpuid},
    {"cmd_whereis", cmd_whereis},
    {"cmd_whatis", cmd_whatis},
    {"cmd_info", cmd_info_v2},
    {"cmd_comm", cmd_comm_v2},
    {"cmd_join", cmd_join_v2},
    {"cmd_bzip2", cmd_bzip2_v2},
    {"cmd_gzip", cmd_gzip_v2},
    {"cmd_xz", cmd_xz_v2},
    {"cmd_zstd", cmd_zstd_v2},
    {"cmd_unzip", cmd_unzip_v2},
    {"cmd_pvcreate", cmd_pvcreate_v2},
    {"cmd_vgcreate", cmd_vgcreate_v2},
    {"cmd_lvcreate", cmd_lvcreate_v2},
    {"cmd_pvdisplay", cmd_pvdisplay_v2},
    {"cmd_vgdisplay", cmd_vgdisplay_v2},
    {"cmd_lvdisplay", cmd_lvdisplay_v2},
    {"cmd_dd", cmd_dd_v2},
    {"cmd_nice", cmd_nice_v2},
    {"cmd_renice", cmd_renice_v2},
    {"cmd_timeout", cmd_timeout_v2},
    {"cmd_xargs", cmd_xargs_v2},
    {"cmd_exec", cmd_exec},
    {"cmd_set", cmd_set},
    {"cmd_hash", cmd_hash},
    {"cmd_type", cmd_type},
    {"cmd_pvremove", cmd_pvremove},
    {"cmd_vgremove", cmd_vgremove},
    {"cmd_lvremove", cmd_lvremove},
    {"cmd_vgextend", cmd_vgextend},
    {"cmd_lvextend", cmd_lvextend},
    {"cmd_lvresize", cmd_lvresize},
    {"cmd_mdadm", cmd_mdadm_v2},
};
